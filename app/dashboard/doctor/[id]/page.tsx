...
import { AppointmentBooking } from "@/components/payment/appointment-booking"
...
const ConsultPage = ({ params }: { params: { id: string } }) => {
  ...
  if (error || !doctor) {
    return (
      <div className="px-4 sm:px-[30px] pt-4 sm:pt-[22px]">
        <div className="text-red-500">Error loading doctor details. Please try again.</div>
      </div>
    )
  }
        ...
        <div>
          <div className="flex items-center justify-between mb-4 sm:mb-[20px]">
            ...
            <Button variants="default">
              <Image src={Search || "/placeholder.svg"} alt="search" loading="lazy" />
            ...
            <div className="mt-4 sm:mt-6">
              <div>
                <article className="bg-white rounded-[12px] rounded-tr-none pt-4 px-4 sm:pt-[16px] sm:px-[20px] max-w-full sm:max-w-[480px] pb-2 ml-auto">
                  <h3 className="text-xs font-medium text-[#808080] leading-[145%]">
                    Hi there! I&apos;m reaching out because I&apos;m dealing with high blood pressure and anxiety. Right
                    now, I&apos;m on Lisinopril for my blood pressure and Sertraline for my anxiety. I would really
                    appreciate any advice or if you could help me with a prescription. Thank you!
                  </h3>
              ...
              <div className="mt-4 sm:mt-[24px] mb-16 sm:mb-[72px]">
                <article className="bg-[#E6F7EE] rounded-[12px] rounded-tl-none pt-4 px-4 sm:pt-[16px] sm:px-[20px] max-w-full sm:max-w-[480px] pb-2">
                  <h3 className="text-xs font-medium text-[#808080] leading-[145%]">
                    Hello! Thank you for reaching out. It&apos;s important to manage both high blood pressure and
                    anxiety effectively. I have sent your diagnosis and prescription to the pharmacist closest to you.
                    let me know if you have more requests
                  </h3>

                  <Button variants="default" className="mt-3 sm:mt-[15px] w-full sm:w-auto">
                    <h2 className="text-sm">Pharm C. obiekwe</h2>

                    <span className="flex items-center text-xs gap-1">
                      <Image src={Locator || "/placeholder.svg"} alt="locator" loading="lazy" />2 metres Away
                    </span>
                  </Button>
            ...
            <div className="mt-[91px] w-fit mx-auto">
              ...
              <div className="bg-[#FCE6E6] border border-[#F18A8A] w-fit py-3 px-[19px] rounded-[7px] mx-auto mt-4">
                <div className="flex items-center gap-2 text-[#E10000]">
                  ...
                  <span className="font-semibold text-[18px] max-sm:text-[16px]">Note</span>
                </div>
        ...
        {paid && (
          <form className="sticky bottom-0 pt-4 pb-2 sm:pb-0 sm:pt-0 sm:bg-transparent">
            <div className="flex items-center gap-x-3 sm:gap-x-5">
              ...
              />
              <Button variants="default" className="py-3 px-4 sm:py-[12px] sm:px-[20px] rounded-full shrink-0">
