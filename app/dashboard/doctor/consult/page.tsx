  ...
  return (
    <section className="relative h-full">
      ...
      <div className="px-4 sm:px-[30px] pt-4 sm:pt-[22px] font-jakarta max-h-[calc(100vh-100px)] overflow-y-auto pb-6 sm:pb-10 h-full flex flex-col justify-between">
        <div>
          <h2 className="text-[#4D4D4D] font-semibold text-lg sm:text-[18px] mb-4 sm:mb-[20px]">
            Prescription
          </h2>
            ...
            <div>
              <article className="bg-white rounded-[12px] rounded-tr-none pt-4 px-4 sm:pt-[16px] sm:px-[20px] max-w-full sm:max-w-[480px] pb-2 ml-auto">
                <h3 className="text-xs font-medium text-[#808080] leading-[145%]">
                  Hi there! I'm reaching out because I'm dealing with high blood
                  pressure and anxiety. Right now, I'm on Lisinopril for my
                  blood pressure and Sertraline for my anxiety. I would really
                  appreciate any advice or if you could help me with a
            ...
            <div className="mt-4 sm:mt-[24px] mb-16 sm:mb-[72px]">
              <article className="bg-[#E6F7EE] rounded-[12px] rounded-tl-none pt-4 px-4 sm:pt-[16px] sm:px-[20px] max-w-full sm:max-w-[480px] pb-2">
                <h3 className="text-xs font-medium text-[#808080] leading-[145%]">
                  ...
                  both high blood pressure and anxiety effectively. I have sent
                  your diagnosis and prescription to the pharmacist closest to
                  you. let me know if you have more requests
                </h3>
                ...
                >
                  ...
                  <span className="flex items-center text-xs gap-1">
                    <Image src={Locator} alt="locator" loading="lazy" />2 metres
                    Away
                  </span>
                </Button>
